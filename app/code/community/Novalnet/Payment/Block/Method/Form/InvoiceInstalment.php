 ...
 */
class Novalnet_Payment_Block_Method_Form_InvoiceInstalment extends Mage_Payment_Block_Form
{
    ...
    {
        parent::_construct();
        $this->setTemplate('novalnet/method/form/InvoiceInstalment.phtml');
    }
